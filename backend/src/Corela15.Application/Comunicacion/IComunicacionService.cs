...
public interface IComunicacionService
{
    ...
    Task<MensajeDto> EnviarMensajeAsync(Guid idCanal, Guid idUsuarioRemitente, string texto, CancellationToken cancellationToken = default);
...
public record MensajeDto(Guid Id, Guid IdCanal, Guid IdUsuarioRemitente, string NombreRemitente, string Texto, DateTimeOffset CreadoEn);
...
public class TextoMensajeInvalidoException() : SolicitudInvalidaException("El mensaje no puede estar vacío ni superar los 2000 caracteres");
